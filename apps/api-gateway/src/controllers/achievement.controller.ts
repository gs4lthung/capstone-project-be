  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        targetStreakLength: {
          type: 'number',
          description: 'Độ dài streak cần đạt (VD: 7)',
        },
        streakUnit: {
          type: 'string',
    ...
    schema: {
      ...
      properties: {
        ...
        entityName: {
          type: 'string',
          description:
            'Tên entity cần check (VD: LearnerProgress, Coach, User)',
        },
        propertyName: {
          type: 'string',
        ...
        targetValue: {
          type: 'string',
          description: 'Giá trị mục tiêu (VD: 80)',
        },
        isActive: { type: 'boolean', description: 'Trạng thái active' },
        icon: {
          type: 'string',
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        targetStreakLength: {
          type: 'number',
          description: 'Độ dài streak cần đạt',
        },
        streakUnit: {
          type: 'string',
          description: 'Đơn vị thời gian (days, weeks, months)',
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        eventName: {
          type: 'string',
          description: 'Tên sự kiện trigger việc check',
        },
