      ...
      lessons: lessonRepository.create([
        ...
        },
        {
          ...
          video: videoRepository.create({
            ...
            drillDescription: 'Các bài tập để cải thiện kỹ thuật đánh forehand',
        ...
        },
        {
          ...
          video: videoRepository.create({
            ...
            drillDescription: 'Các bài tập để cải thiện kỹ thuật đánh backhand',
            drillPracticeSets: '4 set, mỗi set 8 phút',
        ...
        },
        {
          ...
          quiz: quizRepository.create({
            ...
            questions: questionRepository.create([
              ...
              {
                title: 'Điều gì là quan trọng nhất khi thực hiện cú giao bóng?',
                explanation:
